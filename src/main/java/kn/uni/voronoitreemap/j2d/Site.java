...
public class Site extends ASite {
	...
	public boolean equals(Object obj) {
		...
		Site rhs = (Site) obj;
		return new EqualsBuilder().appendSuper(super.equals(obj)).append(isDummy, rhs.isDummy).append(data, rhs.data)
				.isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().appendSuper(super.hashCode()).append(isDummy).append(data).toHashCode();
	}
}